        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <div className="flex gap-2 sm:ml-auto">
            <div className="relative">
              ...
              <Input placeholder="Search..." value={search} onChange={(e) => setSearch(e.target.value)} className="pl-8 w-full sm:w-56" />
            </div>
                ...
                {editId === v.id ? (
                  ...
                  <>
                    ...
                    <TableCell className="text-right whitespace-nowrap">
                      {v.meetingLink && <a href={v.meetingLink} target="_blank" rel="noopener noreferrer"><Button size="icon-xs" variant="outline"><Video className="w-3 h-3" /></Button></a>}
                      <Button size="icon-xs" variant="ghost" onClick={() => startEdit(v)}><Pencil className="w-3 h-3" /></Button>
                      <Dialog><DialogTrigger asChild><Button size="icon-xs" variant="ghost" onClick={() => setDeleteId(v.id)}><Trash2 className="w-3 h-3" /></Button></DialogTrigger>
